...
# # print(std_pe_store_usf)
#
# ratio = 1 / np.shape(std_pe_store_usf)[0]
# covar_usf = 0
# for i in range(int(np.shape(std_pe_store_usf)[0])):
#     covar_usf = covar_usf + (np.sum(test_fcc[0] * np.array(test_usf_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[0] * np.array(test_usf_store[i][1]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_usf_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_usf_store[i][1]) * comp * ratio) - form_E_fcc['E']['Mean'] * (
#                                          ratio * pe_store_usf[i]))
# sum_usf_std = np.sqrt(sum(np.asarray(std_pe_store_usf) ** 2 + (pe_store_usf - np.average(pe_store_usf)) ** 2) /
#                       np.shape(std_pe_store_usf)[0])
...
#     covar_isf = covar_isf + (np.sum(test_fcc[0] * np.array(test_isf_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[0] * np.array(test_isf_store[i][1]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_isf_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_isf_store[i][1]) * comp * ratio) - form_E_fcc['E']['Mean'] * (
#                                          ratio * pe_store_isf[i]))
# sum_isf_std = np.sqrt(sum(np.asarray(std_pe_store_isf) ** 2 + (pe_store_isf - np.average(pe_store_isf)) ** 2) /
#                       np.shape(std_pe_store_isf)[0])
...
#     covar_utf1 = covar_utf1 + (np.sum(test_fcc[0] * np.array(test_utf1_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[0] * np.array(test_utf1_store[i][1]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_utf1_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_utf1_store[i][1]) * comp * ratio) - form_E_fcc['E']['Mean'] * (
#                                            ratio * pe_store_utf1[i]))
# sum_utf1_std = np.sqrt(sum(np.asarray(std_pe_store_utf1) ** 2 + (pe_store_utf1 - np.average(pe_store_utf1)) ** 2) /
#                        np.shape(std_pe_store_utf1)[0])
...
#     covar_esf = covar_esf + (np.sum(test_fcc[0] * np.array(test_esf_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[0] * np.array(test_esf_store[i][1]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_esf_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_esf_store[i][1]) * comp * ratio) - form_E_fcc['E']['Mean'] * (
#                                          ratio * pe_store_esf[i]))
# sum_esf_std = np.sqrt(sum(np.asarray(std_pe_store_esf) ** 2 + (pe_store_esf - np.average(pe_store_esf)) ** 2) /
#                       np.shape(std_pe_store_esf)[0])
...
#     covar_utf2 = covar_utf2 + (np.sum(test_fcc[0] * np.array(test_utf2_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[0] * np.array(test_utf2_store[i][1]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_utf2_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_utf2_store[i][1]) * comp * ratio) - form_E_fcc['E']['Mean'] * (
#                                            ratio * pe_store_utf2[i]))
# sum_utf2_std = np.sqrt(sum(np.asarray(std_pe_store_utf2) ** 2 + (pe_store_utf2 - np.average(pe_store_utf2)) ** 2) /
#                        np.shape(std_pe_store_utf2)[0])
...
#     covar_tf = covar_tf + (np.sum(test_fcc[0] * np.array(test_tf_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[0] * np.array(test_tf_store[i][1]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_tf_store[i][0]) * comp * ratio) + np.sum(
#         test_fcc[1] * np.array(test_tf_store[i][1]) * comp * ratio) - form_E_fcc['E']['Mean'] * (
#                                        ratio * pe_store_tf[i]))
# sum_tf_std = np.sqrt(
#     sum(np.asarray(std_pe_store_tf) ** 2 + (pe_store_tf - np.average(pe_store_tf)) ** 2) / np.shape(std_pe_store_tf)[0])
