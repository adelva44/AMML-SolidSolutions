...
import Potential_old as pot                                                  #Performs potential energy calculations for both Faulted and nonFaulted states
import rdf_coord_old as rc                                                   #Generated Coordination Number (CN) and Radial Distribution Function (RDF) relations based on lattice parameter and cutoff distance
